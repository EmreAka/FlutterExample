...
class _DogsViewState extends State<DogsView> with DogsMixin {
  ...
  StatelessWidget _buildDogsWidget() {
    return switch (viewState) {
      ...
      SearcingState(dogs: final dogs) => DogListWidget(dogs: dogs),
      SearchLoadedState(dogs: final dogs) => DogListWidget(dogs: dogs),
  ...
  LoadingIndicatorWidget? _buildBottomWidget() {
    return switch (viewState) {
      ...
      SearcingState() => const LoadingIndicatorWidget(),
      _ => null,
    };
  }
}
